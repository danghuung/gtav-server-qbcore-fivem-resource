...
Config.Products = {
    ['normal'] = {
        ...
        { name = 'water_bottle',  price = 2,   amount = 1 },
        --{ name = 'kurkakola',     price = 2,   amount = 50 },
        --{ name = 'twerks_candy',  price = 2,   amount = 50 },
        --{ name = 'snikkel_candy', price = 2,   amount = 50 },
        { name = 'sandwich',      price = 2,   amount = 1 },
        --{ name = 'beer',          price = 7,   amount = 50 },
        --{ name = 'whiskey',       price = 10,  amount = 50 },
        --{ name = 'vodka',         price = 12,  amount = 50 },
        { name = 'bandage',       price = 100, amount = 1 },
        --{ name = 'lighter',       price = 2,   amount = 50 },
        --{ name = 'rolling_paper', price = 2,   amount = 5000 },
        { name = 'phone',             price = 850, amount = 1 },
        --{ name = 'jerry_can',   price = 200,  amount = 1 },
        { name = 'armor', price = 2500, amount = 1 },
        --{ name = 'parachute',   price = 2500, amount = 1 },
        { name = 'binoculars',  price = 50,   amount = 1 },
        { name = 'diving_fill', price = 500,  amount = 1 },
        { name = 'diving_gear', price = 2500, amount = 1 },

    },
    ['liquor'] = {
        { name = 'beer',    price = 7,  amount = 1 },
        { name = 'whiskey', price = 10, amount = 1 },
        { name = 'vodka',   price = 12, amount = 1 },
    },
    ['hardware'] = {
    ...
    ['weedshop'] = {
        { name = 'joint',          price = 10,  amount = 1 },
        { name = 'weapon_poolcue', price = 100, amount = 1 },
        { name = 'weed_nutrition', price = 20,  amount = 1 },
        { name = 'empty_weed_bag', price = 2,   amount = 1 },
        { name = 'rolling_paper',  price = 2,   amount = 1 },
    },
    ['gearshop'] = {
    ...
    ['weapons'] = {
        ...
        { name = 'weapon_assaultrifle',  price = 250,  amount = 1 },
        { name = 'weapon_carbinerifle',  price = 250,  amount = 1 },
        --{ name = 'weapon_hatchet',       price = 250,  amount = 250 },
        --{ name = 'pistol_ammo',          price = 250,  amount = 250},
        { name = 'rifle_ammo',          price = 250,  amount = 1},
    ...
    ['blackmarket'] = {
        { name = 'security_card_01',  price = 5000, amount = 1 },
        { name = 'security_card_02',  price = 5000, amount = 1 },
        { name = 'advancedlockpick', price = 5000, amount = 1 },
        { name = 'electronickit',     price = 5000, amount = 1 },
        { name = 'gatecrack',         price = 5000, amount = 1 },
        { name = 'thermite',          price = 5000, amount = 1 },
        --{ name = 'trojan_usb',        price = 5000, amount = 50 },
        --{ name = 'drill',             price = 5000, amount = 50 },
        --{ name = 'radioscanner',      price = 5000, amount = 50 },
        { name = 'cryptostick',       price = 5000, amount = 1 },
    ...
    ['prison'] = {
        { name = 'sandwich',     price = 4, amount = 1 },
        { name = 'water_bottle', price = 4, amount = 1 },
    },
    ['police'] = {
...
Config.Locations = {
    ...
    ['hardware2'] = {
        ...
        ['coordsBlips'] = vector4(2747.71, 3472.85, 55.67, 255.08),
        ['ped'] = 'mp_m_waremech_01',
        ['scenario'] = 'WORLD_HUMAN_CLIPBOARD',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-wrench',
    ...
    ['ammunation3'] = {
        ...
        ['type'] = 'weapon',
        ['coords'] = vector4(1693.47, 3759.49, 34.71, 40.25),
        ['coordsBlips'] = vector4(1692.67, 3761.38, 34.71, 227.65),
        ['ped'] = 's_m_y_ammucity_01',
        ['scenario'] = 'WORLD_HUMAN_COP_IDLES',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-gun',
    ...
    ['ammunation4'] = {
        ['label'] = Config.Blips['ammunation']['label'],
        ['type'] = 'weapon',
        ['coords'] = vector4(-330.48, 6083.24, 31.45, 44.95),
        ['coordsBlips'] = vector4(-331.23, 6085.37, 31.45, 228.02),
        ['ped'] = 's_m_y_ammucity_01',
        ['scenario'] = 'WORLD_HUMAN_COP_IDLES',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-gun',
    ...
    ['ammunation6'] = {
        ['label'] = Config.Blips['ammunation']['label'],
        ['type'] = 'weapon',
        ['coords'] = vector4(21.93, -1107.08, 29.8, 153.75),
        ['coordsBlips'] = vector4(23.0, -1105.67, 29.8, 162.91),
        ['ped'] = 's_m_y_ammucity_01',
        ['scenario'] = 'WORLD_HUMAN_COP_IDLES',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-gun',
    ...
    ['police'] = {
        ...
        ['coordsBlips'] = vector4(461.8498, -981.0677, 30.6896, 91.5892),
    ...
    ['ambulance'] = {
        ...
        ['coordsBlips'] = vector4(309.93, -602.94, 43.29, 71.0820),
        ['ped'] = 's_m_m_doctor_01',
        ['scenario'] = 'WORLD_HUMAN_STAND_MOBILE',
        ['radius'] = 1.5,
    ...
    ['blackmarket'] = {
        ...
        ['coordsBlips'] = vector4(-413.14, -1678.93, 19.03, 105.1),
