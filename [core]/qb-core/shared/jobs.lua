...
QBShared.Jobs = {
	unemployed = { label = 'Thất Nghiệp', defaultDuty = true, offDutyPay = false, grades = { ['0'] = { name = 'Thất Nghiệp', payment = 0 } } },
	...
	police = {
		...
		grades = {
			...
			['1'] = { name = 'Hạ Sĩ', payment = 75 },
			['2'] = { name = 'Thượng Sĩ', payment = 100 },
	...
	ambulance = {
		...
		grades = {
			['0'] = { name = 'Học Việc', payment = 50 },
			['1'] = { name = 'Bác Sĩ', payment = 75 },
			['2'] = { name = 'Viện Trưởng', payment = 100 },
			['3'] = { name = 'Phó Giám Đốc', payment = 125 },
			['4'] = { name = 'Giám Đốc', isboss = true, payment = 150 },
		},
	},
