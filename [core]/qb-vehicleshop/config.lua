...
Config.Shops = {
    ['pdm'] = {
        ...
        ['ShopLabel'] = 'Cửa hàng bán xe',                 -- Blip name
        ...
        ['ShowroomVehicles'] = {
            ...
            [4] = {
                ...
                defaultVehicle = 'rumpo3',
                chosenVehicle = 'rumpo3'
            },
            --[5] = {
    ...
    --    ['ShopLabel'] = 'Cửa hàng bán xe Luxury',
    --    ['showBlip'] = true,   -- true or false
    --    ['blipSprite'] = 326,  -- Blip sprite
    ...
    --    },
    --    ['Job'] = 'none',                                              -- Name of job or none
    --    ['ShopLabel'] = 'Showroom thuyền',                                 -- Blip name
    --    ['showBlip'] = true,                                           -- true or false
    ...
    --    },
    --    ['Job'] = 'none',                                                -- Name of job or none
    --    ['ShopLabel'] = 'Showroom máy bay',                                      -- Blip name
    --    ['showBlip'] = true,                                             -- true or false
    ...
    --    },
    --    ['Job'] = 'none',                                            -- Name of job or none
    --    ['ShopLabel'] = 'Showroom xe tải',                          -- Blip name
    --    ['showBlip'] = true,                                         -- true or false
