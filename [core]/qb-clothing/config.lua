...
Config.Stores = {
    ...
    [1] = {shopType = 'clothing', coords = vector3(-710.36, -153.69, 37.42), width = 2, length = 2},
    [2] = {shopType = 'clothing', coords = vector3(-1192.94495, -772.688965, 17.3255997), width = 2, length = 2},
    [3] = {shopType = 'clothing', coords = vector3(428.95, -800.36, 29.49), width = 2, length = 2},
    [4] = {shopType = 'clothing', coords = vector3(-162.77, -303.22, 39.73), width = 2, length = 2},
    [5] = {shopType = 'clothing', coords = vector3(73.11, -1398.82, 29.38), width = 2, length = 2},
    ...
    [6] = {shopType = 'clothing', coords = vector3(10.52, 6514.87, 31.88), width = 2, length = 2},
    --[10] = {shopType = 'clothing', coords = vector3(615.180, 2762.933, 41.088), width = 2, length = 2},
    [7] = {shopType = 'clothing', coords = vector3(1190.81, 2712.62, 38.22), width = 2, length = 2},
    [8] = {shopType = 'clothing', coords = vector3(-3172.77, 1047.42, 20.86), width = 2, length = 2},
    ...
    [9] = {shopType = 'barber', coords = vector3(137.05, -1708.0, 29.29), width = 2, length = 2},
    --[18] = {shopType = 'barber', coords = vector3(-1282.6, -1116.8, 6.0), width = 2, length = 2},
    [10] = {shopType = 'barber', coords = vector3(1931.72, 3729.76, 32.84), width = 2, length = 2},
    --[20] = {shopType = 'barber', coords = vector3(1212.8, -472.9, 65.2), width = 2, length = 2},
    [11] = {shopType = 'barber', coords = vector3(-32.84, -152.23, 57.08), width = 2, length = 2},
    [12] = {shopType = 'barber', coords = vector3(-278.3, 6228.48, 31.7), width = 2, length = 2}
}

Config.OutfitChangers = {
    --[1] = {shopType = 'outfit', coords = vector3(1697.41, 4829.25, 41.06), width = 2, length = 2},
    [1] = {shopType = 'outfit', coords = vector3(-707.97, -160.73, 37.42), width = 2, length = 2},
    [2] = {shopType = 'outfit', coords = vector3(-1196.53, -769.5, 17.32), width = 2, length = 2},
    [3] = {shopType = 'outfit', coords = vector3(423.35, -799.44, 29.5), width = 2, length = 2},
    [4] = {shopType = 'outfit', coords = vector3(-158.57, -296.26, 39.73), width = 2, length = 2},
    [5] = {shopType = 'outfit', coords = vector3(77.65, -1399.28, 29.39), width = 2, length = 2},
    ...
    [6] = {shopType = 'outfit', coords = vector3(8.01, 6518.52, 31.89), width = 2, length = 2},
    --[10] = {shopType = 'outfit', coords = vector3(617.89, 2766.79, 41.09), width = 2, length = 2},
    [7] = {shopType = 'outfit', coords = vector3(1189.94, 2707.91, 38.23), width = 2, length = 2},
    [8] = {shopType = 'outfit', coords = vector3(-3168.48, 1046.77, 20.86), width = 2, length = 2},
