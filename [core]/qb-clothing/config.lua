...
Config.Stores = {
    ...
    [2] = {shopType = 'clothing', coords = vector3(-710.24, -153.33, 37.42), width = 2, length = 2},
    [3] = {shopType = 'clothing', coords = vector3(-1192.94495, -772.688965, 17.3255997), width = 2, length = 2},
    [4] = {shopType = 'clothing', coords = vector3(428.95, -800.36, 29.49), width = 2, length = 2},
    [5] = {shopType = 'clothing', coords = vector3(-162.658, -303.397, 38.733), width = 2, length = 2},
    [6] = {shopType = 'clothing', coords = vector3(73.11, -1398.82, 29.38), width = 2, length = 2},
    ...
    [9] = {shopType = 'clothing', coords = vector3(10.52, 6514.87, 31.88), width = 2, length = 2},
    --[10] = {shopType = 'clothing', coords = vector3(615.180, 2762.933, 41.088), width = 2, length = 2},
    [11] = {shopType = 'clothing', coords = vector3(1190.81, 2712.62, 38.22), width = 2, length = 2},
    [12] = {shopType = 'clothing', coords = vector3(-3172.77, 1047.42, 20.86), width = 2, length = 2},
...
Config.OutfitChangers = {
    ...
    [2] = {shopType = 'outfit', coords = vector3(-707.97, -160.73, 37.42), width = 2, length = 2},
    [3] = {shopType = 'outfit', coords = vector3(-1188.89, -765.83, 17.32), width = 2, length = 2},
    [4] = {shopType = 'outfit', coords = vector3(423.35, -799.44, 29.5), width = 2, length = 2},
    [5] = {shopType = 'outfit', coords = vector3(-158.57, -296.26, 39.73), width = 2, length = 2},
    [6] = {shopType = 'outfit', coords = vector3(77.65, -1399.28, 29.39), width = 2, length = 2},
    ...
    [9] = {shopType = 'outfit', coords = vector3(8.01, 6518.52, 31.89), width = 2, length = 2},
    --[10] = {shopType = 'outfit', coords = vector3(617.89, 2766.79, 41.09), width = 2, length = 2},
    [11] = {shopType = 'outfit', coords = vector3(1189.94, 2707.91, 38.23), width = 2, length = 2},
