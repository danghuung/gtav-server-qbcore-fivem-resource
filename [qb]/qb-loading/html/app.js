...
const load = Vue.createApp({
  setup () {
    return {
      ...
      //
      // KeybindTitle: 'Tổ hợp phím tắt',
      // Keybind1: 'Mở khoảng không quảng cáo',
      // Keybind2: 'Chu kỳ gần',
      // Keybind3: 'Mở điện thoại',
      // Keybind4: 'Thắt an toàn',
      // Keybind5: 'Mở menu mục tiêu',
      // Keybind6: 'Menu xuyên tâm',
      // Keybind7: 'Mở menu Hud',
