...
Config.Strings = {
	ExitVehicle = "Xuống xe để đổ xăng",
	EToRefuel = "Nhấn ~g~E ~w~để tiếp nhiên liệu cho xe",
	JerryCanEmpty = "Can xăng đang rỗng",
	FullTank = "Xăng đang đầy bình, không thể đổ",
	PurchaseJerryCan = "Nhấn ~g~E ~w~để mua can xăng với giá ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Nhấn ~g~E ~w~để hủy nạp nhiên liệu",
	CancelFuelingJerryCan = "Nhấn ~g~E ~w~để hủy nạp nhiên liệu",
	NotEnoughCash = "Không đủ tiền mặt",
	RefillJerryCan = "Nhấn ~g~E ~w~ để đổ đầy bình jerry cho ",
	NotEnoughCashJerryCan = "Không đủ tiền để đổ đầy can xăng",
